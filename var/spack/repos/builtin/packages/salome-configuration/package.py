...
class SalomeConfiguration(Package):
    ...
    version("9.11.0", tag="V_9_11_0", commit="33fc859a523e9f84cabaae2c55fdc64d1be11ec0");
    version("9.10.0", tag="V_9_10_0", commit="25f724f7a6c0000330a40c3851dcd8bc2493e1fa");
